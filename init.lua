...
vim.keymap.set('n', '<leader>c', ':Neotree focus<CR>')
...
require('lazy').setup({
  ...
  -- require 'custom.plugins.pyright',
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'python', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' }
